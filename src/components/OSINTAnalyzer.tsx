...
const INPUT_TYPES = [
  ...
  { value: 'domain', label: 'Domain', icon: Globe, description: 'Domain name investigation with WHOIS', examples: ['example.com', 'github.com'] },
  ...
  { value: 'social_media', label: 'Social Media Enumeration', icon: Users, description: 'Find usernames across social networks using Sherlock', examples: ['johndoe', 'tech_user', 'alice123'] },
  { value: 'phone', label: 'Phone Number', icon: Phone, description: 'Phone number investigation with Inspector', examples: ['+33666666666', '+1-555-123-4567'] },
